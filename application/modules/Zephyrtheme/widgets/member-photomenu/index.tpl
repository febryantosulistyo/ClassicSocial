...
// Headline
if(empty($this->mpmShowheadline)) { $this->mpmShowheadline = 1; } else { $this->mpmShowheadline = $this->mpmShowheadline; }
// Photo
...
<div id="memberphotomenu_container">
  ...
  <div id="memberphotomenu_photo">
    ...
    <div>
      <?php echo $this->htmlLink($this->viewer()->getHref(), $this->itemPhoto($this->viewer(), 'thumb.profile'), array(
              'class' => 'memberphotomenu_photo_linkimg',
            )); ?>
...
<?php
// Do not render if everything was disabled.
if($this->mpmShowheadline == 2 && $this->mpmShowphoto == 2 && $this->mpmShowmenu == 2)
